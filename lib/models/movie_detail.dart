...
MovieDetail({required this.title,required this.imdbId,required this.poster,required this.year,
  required this.released,required this.genre,required this.actors,required this.writer,required this.plot,});
